...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
 Title="Aegis Palworld Suite 2.3.3" Width="1520" Height="960" MinWidth="1260" MinHeight="780"
 ...
 <Window.Resources>
  ...
  <Style x:Key="Nav" TargetType="RadioButton"><Setter Property="Foreground" Value="#DDE8F4"/><Setter Property="Background" Value="Transparent"/><Setter Property="Cursor" Value="Hand"/><Setter Property="Template"><Setter.Value><ControlTemplate TargetType="RadioButton"><Border x:Name="nav" CornerRadius="5" Margin="8,7" Padding="22,10" Background="{TemplateBinding Background}" BorderBrush="#162A3D" BorderThickness="1"><StackPanel Orientation="Horizontal" HorizontalAlignment="Center"><Border Width="34" Height="34" Background="#08192A" BorderBrush="#315273" BorderThickness="1" CornerRadius="5" Margin="0,0,11,0"><TextBlock Text="{TemplateBinding Tag}" FontFamily="Segoe MDL2 Assets" FontSize="19" Foreground="#E2F0FF" HorizontalAlignment="Center" VerticalAlignment="Center"/></Border><TextBlock Text="{TemplateBinding Content}" FontSize="15" FontWeight="SemiBold" VerticalAlignment="Center"/></StackPanel></Border><ControlTemplate.Triggers><Trigger Property="IsChecked" Value="True"><Setter TargetName="nav" Property="Background" Value="#07469B"/><Setter TargetName="nav" Property="BorderBrush" Value="#1487FF"/><Setter Property="Foreground" Value="White"/></Trigger><Trigger Property="IsMouseOver" Value="True"><Setter TargetName="nav" Property="Background" Value="#102944"/><Setter TargetName="nav" Property="BorderBrush" Value="#3B6A92"/></Trigger></ControlTemplate.Triggers></ControlTemplate></Setter.Value></Setter></Style>
 </Window.Resources>
 <Grid>
